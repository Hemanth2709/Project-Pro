...
export default function EditEventPage({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    editEvent(resolvedParams.id, eventData)
          ...
          <Card>
            <form onSubmit={handleSubmit}>
              <CardHeader>
                ...
                <CardDescription>Edit the event details</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="grid gap-2">
                  ...
                  <DatePicker onSelect={handleDateChange} value={new Date(eventData.date)} />
                </div>
                <div className="grid gap-2">
                  <Label htmlFor="projectId">Related Project</Label>
                  <Select onValueChange={handleSelectChange} value={eventData.projectId}>
                    <SelectTrigger>
