            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  Plan, execute, and monitor your projects efficiently. Facilitate collaboration among team
                  members, assign tasks, and manage resources.
                </p>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-8">
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Create, assign, and monitor tasks. Set priorities and deadlines to keep your project on
                    track.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Facilitate communication and collaboration among team members with integrated tools.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card>
